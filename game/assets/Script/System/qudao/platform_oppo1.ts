...
// import {BossFightingType, gameCode, qudaoType} from "../System/Type/enums";
// import NativeAdDialog from "../Dialog/NativeAdDialog";
// import sys = cc.sys;
...
//                         nativeAd.reportAdShow({ adId: nativeCurrentAd.adId.toString() });
//                         cc.assetManager.loadRemote(remoteUrl, (err, texture) => {
//                             // console.log("下载资源图片完成",texture);
//                             let successfulCallback = () => {
//                                 nativeAd.reportAdClick({ adId: nativeCurrentAd.adId.toString() })
//                             };
...
//                                 }
//                                 // console.log("现在要去展示图片广告了",texture);
