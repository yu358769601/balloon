...
export default class Menu extends cc.Component implements IChannelBase{
    ...
    removeEmitter() {
        ...
        Emitter.remove('onThisPass', this.onThisPass, this)
    ...
    registerEmitter() {
        ...
        Emitter.register('onThisPass', this.onThisPass, this)
    ...
    onLoad() {
        ...
        // let data = {
        //     name : PassItemType.关卡,
        //     callBack : ()=>{
        //         ccLog.log("预添加",PassItemType.关卡)
        //     }
        // }
        //
        // Emitter.fire("onTempNodeInit",data)
   ...
   async onShowAllByGetLuck(selfName,b){
     ...
     this.passData = data
        ...
        let addGemData = {
            ...
            callback_donthave : async ()=>{
                ...
                myPassSave.passName =this.passData.itemName
                ...
                // Emitter.fire("onOpenDialog",{name : DialogType.限时礼包,zIndex : 100,data:data},null)
                Emitter.fire("onOpenDialogByGetLuckDialog",data1)
            },
    ...
    async onThisPass(selfName, data) {
        ccLog.log("要给过去的数据是 1 ", data)
   ...
   async onShowAll(selfName,b) {
       ...
       if (this.菜单_画8.active == false && b == true) {
           ...
           this.channel.closeBannerByMenu()
